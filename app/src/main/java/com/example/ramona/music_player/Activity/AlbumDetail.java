...
public class AlbumDetail extends AppCompatActivity implements PlayControl{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDB = new MyDatabase(AlbumDetail.this);
        initControl();
    ...
    private void initData() {
        ...
        if (bundle != null) {
            AlbumEntities entities = bundle.getParcelable(Constant.ALBUM_ENTITY);
            int id = entities.getmAlbumID();
            mCollapsingToolbarLayout.setTitle(entities.getmAlbumName());
            mListSong.addAll(mDB.getListSongByAlbumID(id + ""));
            if (mListSong.size() > 0) {
            ...
            if (Models.getCoverAlbum(entities.getmAlbumArt()) != null) {
                Glide.with(this).asBitmap().load(Models.getCoverAlbum(entities.getmAlbumArt())).into(mCoverAlbum);
            }
        }
        mDB.close();
    }
    ...
    private void initEvent() {
        mAdapter.SetOnItemClickListener(new ClickListener() {
            ...
            public void OnItemClick(int position) {
                Intent intent = new Intent(AlbumDetail.this, PlaySong.class);
    ...
    protected void onStart() {
        super.onStart();
        Intent mIntent = new Intent(AlbumDetail.this, ServicePlayMusic.class);
